 ...
 * @package App\Domain\Notification\Model\Base
 */
abstract class BaseNotification implements NotificationInterface
{
     ...
     * @param bool $isSeen
     */
    public function create(string $title, string $description,\DateTime $dateOfSending, User $recipient, User $sender, $isSeen = true): self
    {
        $this->title = $title;
